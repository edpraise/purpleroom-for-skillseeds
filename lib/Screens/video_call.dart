        ...
        child: Column(
          ...
          children: [
             ...
             CircularProfileAvatar(
                  ...
                  SizedBox(height:10),
                  Text("Tasun Prasad", style: TextStyle(color:Colors.white, fontSize: 20),),
                  SizedBox(height: 10),

                  Text("Calling...", style: TextStyle(color:Colors.orange, fontSize: 15), ),
                  SizedBox(height:40),
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.mic_off, size: 60,color: Colors.white),
                         Container(
                        height: 70,
                        width: 80,
                        decoration: BoxDecoration(
