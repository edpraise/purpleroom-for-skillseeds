      ...
      body: Container(
        child: Padding(
          ...
          child: Column(
            ...
            Text("Counsellors Online", style: TextStyle(color:Colors.white,fontSize:10), ),
            SizedBox(height: 20),
            Row(
                ...
                CircularProfileAvatar(
                      ...
                      Column(
                        children: [
                          ...
                          Text("Berlin Germany", style: TextStyle(color: Colors.white)),
                        ],
                      ),
                      GestureDetector(
                        onTap:(){
                          ...
                          child: Center(child: Text("Book now", style: TextStyle(color: Colors.black)))
                        ),
                      ),      
              ],
            ),
